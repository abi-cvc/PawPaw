                            ...
                            <div class="qr-card">
                                ...
                                <div class="qr-pet-info">
                                    <% if (pet.getPhoto() != null && !pet.getPhoto().isEmpty()) { %>
                                        <img src="<c:out value="${petItem.photo}"/>" alt="<c:out value="${petItem.namePet}"/>" class="qr-pet-photo">
                                    <% } else { %>
                                        <div class="qr-pet-photo-placeholder">🐾</div>
                                    <% } %>
                                    <div>
                                        <h3><c:out value="${petItem.namePet}"/></h3>
                                        <p><c:out value="${petItem.breed != null ? petItem.breed : 'Sin raza especificada'}"/></p>
                                    </div>
                                </div>
                                ...
                                <div class="qr-actions">
                                    <!-- Ver página pública -->
                                    <a href="${pageContext.request.contextPath}/pet/<%= pet.getIdPet() %>"
                                       target="_blank"
