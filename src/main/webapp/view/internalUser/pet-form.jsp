            ...
            <form method="POST" action="<%= request.getContextPath() %>/user/pets/<%= isEdit ? "edit" : "new" %>" class="form-grid" id="petForm">
                ...
                <div class="form-group form-group-full">
                    ...
                    <textarea id="medicalConditions" 
                              ...
                              placeholder="Ej: Alérgico al pollo, artritis, toma medicamento X"><%= medicalConditions %></textarea>
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    <textarea id="extraComments" 
                              name="extraComments" 
                              class="form-textarea form-input"
                              placeholder="Información adicional sobre tu mascota (comportamiento, preferencias, etc.)"><%= extraComments %></textarea>
                </div>
