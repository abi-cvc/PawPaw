...
<body>
    <div class="dashboard">
        ...
        <div class="main-content">
            <div class="topbar">
                <div class="topbar-title"><h1>Enviar Sugerencia</h1></div>
            </div>
            <div class="content">
                ...
                <div class="tarjeta" style="max-width: 800px; margin: 0 auto;">
                    <div style="padding: 2rem;">
                        <div style="text-align: center; margin-bottom: 2rem;">
                            ...
                            <p style="color: #666; margin: 0;">Comparte tus ideas, sugerencias o comentarios para ayudarnos a mejorar PawPaw</p>
                        </div>
                        <form action="${pageContext.request.contextPath}/user/send-suggestion" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="message" name="message" class="form-input" rows="8"
                                    ...
                                    style="resize: vertical; font-family: var(--fuente-texto);"><c:out value="${message}"/></textarea>
                                <small style="color: #999; font-size: 0.875rem; display: block; margin-top: 0.5rem;">Mínimo 10 caracteres, máximo 1000 caracteres</small>
                            </div>
                            <div style="background: #f0f9ff; border-left: 4px solid var(--color-info); padding: 1rem; border-radius: var(--radio-sm); margin-bottom: 1.5rem;">
                                <p style="margin: 0; font-size: 0.9rem; color: #666;"><strong>💡 Consejo:</strong> Sé específico en tu sugerencia. Cuanto más detalles nos brindes, mejor podremos entender y atender tu solicitud.</p>
                            </div>
                            <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                                <button type="submit" class="btn btn-primario" style="flex: 1; min-width: 200px;">Enviar Sugerencia</button>
                                <a href="${pageContext.request.contextPath}/user/panel" class="btn btn-secundario" style="flex: 1; min-width: 200px; text-align: center; display: flex; align-items: center; justify-content: center;">Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
                <div style="max-width: 800px; margin: 2rem auto 0; text-align: center;">
                    <p style="color: #999; font-size: 0.9rem;">Todas las sugerencias son revisadas por nuestro equipo. Te responderemos lo antes posible.</p>
                </div>
            </div>
        </div>
    </div>
