                    ...
                    <div style="padding: 2rem;">
                        ...
                        <form action="${pageContext.request.contextPath}/user/send-suggestion" method="post">
                            ...
                            <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                                ...
                                <a href="${pageContext.request.contextPath}/user/panel" class="btn btn-secundario" style="flex: 1; min-width: 200px; text-align: center; display: flex; align-items: center; justify-content: center;">
                                    Cancelar
                                </a>
                            </div>
                        </form>
