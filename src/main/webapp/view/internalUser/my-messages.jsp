    ...
    <div class="dashboard">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<%= request.getContextPath() %>/user/messages" class="nav-item active">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="main-content">
            ...
            <div class="filter-section">
                ...
                <div class="filter-buttons">
                    <a href="<%= request.getContextPath() %>/user/messages" 
                       class="filter-btn <%= currentFilter == null || currentFilter.isEmpty() ? "active" : "" %>">
                        Todos
                    </a>
                    <a href="<%= request.getContextPath() %>/user/messages?filter=unread" 
                ...
                <div class="message-card <%= msg.isUnread() ? "unread" : "" %>">
                    <div class="message-header">
                        <div class="message-pet-info">
                            ...
                            <img src="<%= msg.getPetPhoto() %>" alt="<%= msg.getPetName() %>" class="message-pet-photo">
                            <% } else { %>
                            <div class="message-pet-photo-placeholder">🐾</div>
                            <% } %>
                            <div>
                                <h3>Sobre <%= msg.getPetName() %></h3>
                                <% if (msg.getPetBreed() != null) { %>
                                <span class="message-pet-breed"><%= msg.getPetBreed() %></span>
                                <% } %>
                            </div>
                        </div>
                    ...
                    <div class="message-body">
                        <div class="message-sender">
                            <strong>De:</strong> <%= msg.getSenderName() %>
                        </div>
                        <div class="message-phone">
                            <strong>Teléfono:</strong> 
                            <a href="tel:<%= msg.getSenderPhone() %>"><%= msg.getSenderPhone() %></a>
                        </div>
                    ...
                    <div class="message-actions">
                        <a href="tel:<%= msg.getSenderPhone() %>" class="btn btn-primario btn-small">
                            📞 Llamar
                        </a>
