...
<head>
    ...
    <title>Historial de Slots - <c:out value="${user != null ? user.getNameUser() : 'Usuario'}"/> - PawPaw Admin</title>
    ...
    <div class="dashboard">
        ...
        <main class="main-content">
            ...
            <div class="content-header">
                <div>
                    <a href="${pageContext.request.contextPath}/admin/users" class="btn btn-secundario" style="margin-bottom: 1rem;">
                        ← Volver a usuarios
                    </a>
                    <h1 class="content-title">📜 Historial de Slots - <c:out value="${user.getNameUser()}"/></h1>
            ...
            <div class="user-info-card">
                <div class="user-info-header">
                    ...
                    <div>
                        <h2><c:out value="${user.getNameUser()}"/></h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:out value="${adj.getAdminName()}"/>
                                <% } else { %>
                                <em>Sistema</em>
                                <% } %>
                            </td>
                            <td><c:out value="${adj.getPreviousLimit()}"/></td>
                            <td><c:out value="${adj.getNewLimit()}"/></td>
                            <td>
                                <% if (adj.isIncrease()) { %>
                                <span class="change-badge increase">+<c:out value="${adj.getAdjustmentAmount()}"/></span>
                                <% } else if (adj.isDecrease()) { %>
                                <span class="change-badge decrease"><c:out value="${adj.getAdjustmentAmount()}"/></span>
                                <% } else { %>
                                <span class="change-badge neutral">0</span>
                                <% } %>
                            </td>
                            <td class="reason-cell"><c:out value="${adj.getAdjustmentReason()}"/></td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
            ...
            <div class="empty-state">
                ...
                <p><a href="${pageContext.request.contextPath}/admin/users">Volver a la lista de usuarios</a></p>
            </div>
            <% } %>
        </main>
    </div>
