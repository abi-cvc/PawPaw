        ...
        <div class="transfer-container">
            ...
            <div class="transfer-card">
                <div class="transfer-pet-info">
                    ...
                    <h2><c:out value="${transfer.petName}"/></h2>
                    <p class="foundation-name">De: <c:out value="${transfer.foundationName}"/></p>
                </div>

                <div class="transfer-details">
                    <div class="detail-row">
                        <span class="detail-label">Para:</span>
                        <span class="detail-value"><c:out value="${transfer.adopterName}"/></span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Email:</span>
                        <span class="detail-value"><c:out value="${transfer.adopterEmail}"/></span>
                    </div>
                    <div class="detail-row">
                ...
                <div class="transfer-info-box">
                    ...
                    <ul>
                        <li>✅ <c:out value="${transfer.petName}"/> será oficialmente tuyo/a</li>
                        <li>✅ Podrás editar su perfil y actualizar información</li>
                        <li>✅ El código QR seguirá funcionando con tus datos</li>
                        <li>✅ Recibirás notificaciones sobre <c:out value="${transfer.petName}"/></li>
                    </ul>
                </div>
            ...
            <div class="transfer-footer">
                <p>¿No eres <c:out value="${transfer.adopterName}"/>?
        ...
        <div class="modal-container">
            ...
            <form method="post" action="${pageContext.request.contextPath}/accept-transfer">
                ...
                <div class="modal-body">
                    <p>¿Estás seguro de que deseas rechazar la transferencia de <strong><c:out value="${transfer.petName}"/></strong>?</p>
