...
public class ResetPasswordServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        logger.info("Validando token: {}...", token.substring(0, 10));
        ...
        if (!resetToken.isValid()) {
            logger.info("Token expirado o ya usado");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        logger.info("Intentando resetear contrasena con token");
        ...
        try {
            ...
            if (userDAO.resetPassword(user.getIdUser(), hashedPassword)) {
                logger.info("Contrasena actualizada para: {}", user.getEmail());
                ...
                logger.error("Error al actualizar contrasena en BD");
            ...
            logger.error("Error al resetear contrasena: {}", e.getMessage(), e);
