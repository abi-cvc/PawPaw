...
public class CapturePayPalOrderServlet extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(CapturePayPalOrderServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("Capturando pago PayPal - Order: {}, User: {}", orderId, userId);
            ...
            if ("COMPLETED".equals(status)) {
                ...
                if (slotsAdded) {
                    ...
                    logger.info("Pago completado - {} slots agregados a usuario {}", slots, userId);
            ...
            logger.error("Error al capturar pago", e);
