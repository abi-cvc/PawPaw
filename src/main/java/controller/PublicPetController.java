...
public class PublicPetController extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(PublicPetController.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("Vista publica de mascota: {} (ID: {})", pet.getNamePet(), petId);
            ...
            try {
                ...
                logger.error("Error al registrar escaneo: {}", e.getMessage());
            }
    ...
    private void handleSendMessage(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (emailSent || savedInDB) {
                logger.info("Mensaje procesado - Email: {} | BD: {}", emailSent, savedInDB);
    ...
    private void handleReportFound(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (updated) {
                ...
                logger.info("Mascota {} reportada como encontrada", petId);
                redirectWithSuccess(request, response, petIdStr,
            ...
            logger.error("Error al reportar mascota encontrada: {}", e.getMessage(), e);
            String petIdStr = request.getParameter("petId");
