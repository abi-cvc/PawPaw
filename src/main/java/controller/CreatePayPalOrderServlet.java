...
public class CreatePayPalOrderServlet extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(CreatePayPalOrderServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("Creando orden PayPal: {} slots por ${}", slots, amount);
            ...
            logger.error("Error al crear orden PayPal: {}", e.getMessage(), e);
