...
public class SendSuggestionServlet extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(SendSuggestionServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (suggestionDAO.create(suggestion)) {
                logger.info("Sugerencia creada exitosamente por usuario ID: {}", userId);
                ...
                logger.error("Error al guardar sugerencia en BD");
            ...
            logger.error("Error al procesar sugerencia: {}", e.getMessage(), e);
